...
import '../../src/components/cwk-app-shell';

const fixture = _fixture as (arg: TemplateResult) => Promise<AppShell>;
...
describe('App Shell Component', () => {
  ...
  it('renders a list of participant capsules for all participants', async () => {
    ...
    const capsules = Array.from(
      el.shadowRoot?.querySelectorAll('cwk-participant-frontend-capsule') || [],
    ) as ParticipantFrontendCapsule[];
